      ...
      <div className="  max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            dolorem asperiores ratione, eaque doloremque assumenda vel iure
            consequatur at sint, accusantium veritatis tenetur amet corporis
            repellendus libero iste fugit?
          </p>
          <a
            href="#"
